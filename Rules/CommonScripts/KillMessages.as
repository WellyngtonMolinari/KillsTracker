...
void onPlayerDie(CRules@ this, CPlayer@ victim, CPlayer@ killer, u8 customdata)
{
	if (victim !is null)
	{
        ...
        string killerName = (killer !is null) ? killer.getCharacterName() : "unknown";

        // Log or send the kill event to the TCPR socket
        string killMessage = "Kill: " + killerName + " killed " + victimName;
        printf(killMessage);  // This will print to the server console
	}
}
